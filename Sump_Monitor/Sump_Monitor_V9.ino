...
String processor2(const String &var) {
  ...
  while (file) {
    ...
    if(file_name.startsWith("DISTANCE") || file_name.startsWith("LOG") || file_name.startsWith("ALERT")) {
...
void handleAlexaReporting() {
  ...
  //Log and timestamp  distance to Target every 6 minutes
