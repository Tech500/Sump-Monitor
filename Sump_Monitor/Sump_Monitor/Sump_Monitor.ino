...
void setupSinricPro() {
  ...
  SinricProContactsensor &myHighWater = SinricPro[HIGH_WATER_ID];
  SinricProContactsensor &myFlooding  = SinricPro[FLOODING_ID];
  SinricProContactsensor &myAllClear  = SinricPro[ALL_CLEAR_ID];
...
void ultrasonic() {
  ...
  //distanceToTarget = (pingTravelDistance / 2);  // normal use ubcomment
